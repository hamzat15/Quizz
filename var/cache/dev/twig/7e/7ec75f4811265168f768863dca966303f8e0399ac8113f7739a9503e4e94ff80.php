...
class __TwigTemplate_92bf8661afe0df3e6447aa1f8ffd2f613da08f8f516f49bc7f930114d05d52e9 extends Template
{
    private $source;
    private $macros = [];
    ...
    <table class=\"table\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["categorie"]) {
            ...
            echo "</td>
                <td><a href=\"";
            // line 20
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("questions_index", ["id" => twig_get_attribute($this->env, $this->source, $context["categorie"], "id", [], "any", false, false, false, 20)]), "html", null, true);
            echo "\">";
...
";
    ...
    {
        return array (  147 => 34,  142 => 31,  133 => 27,  124 => 23,  120 => 22,  113 => 20,  109 => 19,  106 => 18,  101 => 17,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% block body %}
    ...
    <table class=\"table\">
        ...
        {% for categorie in categories %}
            <tr>
                <td>{{ categorie.id }}</td>
                <td><a href=\"{{ path('questions_index', {'id': categorie.id}) }}\">{{ categorie.name }}</a></td>
                <td>
...
{% endblock %}
", "categorie/index.html.twig", "/home/wac/delivery/W-PHP-502-PAR-2-2-Quiz-edmond.loembe-sauthat/my_Quiz/templates/categorie/index.html.twig");
    }
}
